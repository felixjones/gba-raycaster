...
inline constexpr auto fx_div2( const fixed_type& lhs ) noexcept {
    return fixed_type::from_data( lhs.data() >> 1 );
}

inline constexpr auto fx_mul64( const fixed_type& lhs ) noexcept {
    return fixed_type::from_data( lhs.data() << 6 );
}
...
uint32 raycaster::ray_cast( const fixed_type& xx, const fixed_type& dirX, const fixed_type& dirY, const fixed_type& planeX, const fixed_type& planeY, const fixed_type& posX, const fixed_type& posY, fixed_type& outPerpWallDist, uint32& outTexX ) const noexcept {

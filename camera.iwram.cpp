...
static constexpr auto camera_size = fixed_type { 1.0 / 4.0 };
...
camera_type::camera_type(fixed_type startX, fixed_type startY, std::int32_t startAngle) : x { startX }, y { startY }, angle { startAngle } {
